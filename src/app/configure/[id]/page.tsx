...
export default function ConfigurePage({ params }: PageProps) {
  const { id } = use(params);
  ...
  return (
    <main className="flex-grow flex flex-col pt-20 relative overflow-hidden h-[calc(100vh-80px)] bg-[#131313]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-10 left-10 flex flex-col gap-2 z-10 pointer-events-none">
            <div className="flex items-center gap-4">
              <span className="text-[#adc6ff] font-mono text-[10px] tracking-widest uppercase">Telemetry active</span>
